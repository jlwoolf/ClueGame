...
public class BoardAdjTargetTest {
	...
	public void testTargetsInChauvenetHall() {
		// test a roll of 1
		board.calcTargets(board.getCell(0, 17), 1);
		Set<BoardCell> targets= board.getTargets();
		assertEquals(2, targets.size());
		assertTrue(targets.contains(board.getCell(24, 2)));
		assertTrue(targets.contains(board.getCell(2, 15)));	

		// test a roll of 3
		board.calcTargets(board.getCell(0, 17), 3);
		...
		// test a roll of 4
		board.calcTargets(board.getCell(0, 17), 4);
		targets= board.getTargets();
	...
	public void testTargetsInCoorsTech() {
		...
		// test a roll of 3
		board.calcTargets(board.getCell(20, 17), 3);
		targets= board.getTargets();
		...
		// test a roll of 4
		board.calcTargets(board.getCell(20, 17), 4);
		targets= board.getTargets();
	...
	public void testTargetsInWalkway1() {
		...
		assertEquals(6, targets.size());
		assertTrue(targets.contains(board.getCell(24, 2)));
		assertTrue(targets.contains(board.getCell(29, 11)));
	...
	public void testTargetsOccupied() {
		...
		assertTrue(targets.contains(board.getCell(28, 20)));
		...
		board.calcTargets(board.getCell(29, 11), 3);
		board.getCell(23, 8).setOccupied(false);
		targets= board.getTargets();
		assertEquals(10, targets.size());
		assertTrue(targets.contains(board.getCell(28, 20)));
		assertTrue(targets.contains(board.getCell(31, 5)));	
		assertFalse(targets.contains(board.getCell(23, 10)));
	}
}
